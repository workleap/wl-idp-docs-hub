...
Reduce skill token consumption (metadata bloat) without losing coverage. | [workleap-skill-optimizer](https://skills.sh/workleap/wl-web-configs/workleap-skill-optimizer) | - |
